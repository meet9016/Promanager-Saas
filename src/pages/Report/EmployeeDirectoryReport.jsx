            ...
            <div className="p-8  mx-auto h-full flex flex-col overflow-hidden">
                ...
                {reportData && (
                    <div className="h-[80vh] bg-[var(--color-bg-secondary)] rounded-xl shadow-sm border border-primary-200 overflow-hidden flex flex-col flex-1 min-h-0 custom-scrollbar">
                        ...
                        {/* Table */}
                        {reportData.length === 0 ? (
                            <div className="flex flex-1 items-center justify-center h-full bg-[#FBF9FD] rounded-xl border-t border-[var(--color-border-secondary)]">
                                <NoDataFound
                                    title="No Employees Found"
                                    subtitle="No employees match your current filter criteria."
                                />
                            </div>
                        ) : (
