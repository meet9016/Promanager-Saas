                        ...
                        {shift.attendance_arr?.map((a, i) => (
                          <tr key={i} className="hover:bg-[var(--color-primary-lightest)]">
                            ...
                            <td className="px-3 py-2 text-center">
                              <span className={`px-2 py-0.5 rounded-full text-xs font-semibold ${a.status_name === 'Complete hours' ? 'bg-green-100 text-green-800' : a.status_name === 'Incomplete hours' ? 'bg-yellow-100 text-yellow-800' : a.status_name === 'Overtime hours' ? 'bg-primary-100 text-primary-800' : 'bg-gray-200 text-gray-800'}`}>
                                {a.status_name}
                              </span>
                            </td>
