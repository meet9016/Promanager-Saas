...
const LoanAdvance = () => {
    ...
    const renderStatusBadge = useCallback((status) => {
        const statusColors = {
            ...
            'Under Review': 'bg-[var(--color-primary-lighter)] text-[var(--color-primary-darkest)]',
    ...
    const renderLoanTypeBadge = useCallback((loanType) => {
        return (
            <span className={`px-2 py-1 rounded-full text-xs font-medium ${loanType === 'Loan'
                ? 'bg-[var(--color-primary-lighter)] text-[var(--color-twxt-white)]'
        ...
        <div className="h-[calc(100vh-64px)] overflow-hidden bg-[var(--color-bg-primary)]">
            <div className="p-8  mx-auto">
                ...
                <div className="bg-[var(--color-bg-secondary)] h-[87vh] rounded-lg border border-[var(--color-primary-dark)] overflow-visible shadow-sm flex flex-col">
                    <div className="px-6 py-3 border-b border-[var(--color-primary-light)] bg-[var(--color-primary-lighter)] rounded-tl-[7px] rounded-tr-[7px]">
                    ...
                    {loading ? (
                        ...
                        <div className="flex-1 min-h-0 flex items-center justify-center bg-[#FBF9FD] rounded-[10px]">
                            <NoDataFound
