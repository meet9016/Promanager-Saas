...
const useCompanies = () => {
    ...
    const addCompany = async (companyData) => {
        ...
        try {
            ...
            // Add delete flags if provided (for updates) 
            if (companyData.company_logo_delete !== undefined) {
                formData.append('company_logo_delete', companyData.company_logo_delete);
            }
            if (companyData.signature_delete !== undefined) {
                formData.append('signature_delete', companyData.signature_delete);
            }
