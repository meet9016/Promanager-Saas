...
export default function Error404Page() {
    return (
        <div className="w-full h-screen bg-primary-700 overflow-x-hidden flex justify-center items-center relative">
            <MessageDisplay />
            <CharactersAnimation />
            <CircleAnimation />
        </div>
...
function MessageDisplay() {
    ...
    return (
        <div className="absolute flex flex-col justify-center items-center w-[90%] h-[90%] z-[100]">
            ...
            >
                <div className="text-[35px] font-semibold text-[var(--color-primary-darker)] m-[1%]">
                    Page Not Found
                </div>
                <div className="text-[80px] font-bold text-[var(--color-primary-darker)] m-[1%]">404</div>
                <div className="text-[15px] w-1/2 min-w-[40%] text-center text-[var(--color-primary-darker)] m-[1%]">
                ...
                <div className="flex gap-6 mt-8">
                    <button
                        // onClick={() => navigate(-1)}
                        className="text-[var(--color-primary-darker)] border-2 border-primary-700 hover:bg-primary-700 hover:text-white transition-all duration-300 ease-in-out px-6 py-2 h-auto text-base font-medium flex items-center gap-2 hover:scale-105"
                    >
                        <svg
                    ...
                    <button
                        // onClick={() => navigate("/")}
                        className="bg-primary-700 text-white hover:bg-primary-600 transition-all duration-300 ease-in-out px-6 py-2 h-auto text-base font-medium flex items-center gap-2 hover:scale-105"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="20"
